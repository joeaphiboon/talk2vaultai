...
export const BrainCircuitIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M12 5a3 3 0 1 0 5.993.134"/>
        <path d="M15 13a3 3 0 1 0-5.993.134"/>
        <path d="M15 13a3 3 0 1 0 5.993.134"/>
        <path d="M9 13a3 3 0 1 0-5.993.134"/>
        <path d="M6.007 8.134A3 3 0 0 0 9 13"/>
        <path d="M17.993 8.134A3 3 0 0 0 15 13"/>
        <path d="M12 5v0a3 3 0 0 0-2.993 3.134"/>
        <path d="M12 5v0a3 3 0 0 1 2.993 3.134"/>
        <path d="M12 19a3 3 0 1 0-5.993-.134"/>
        <path d="M12 19a3 3 0 1 0 5.993-.134"/>
        <path d="M9 13c0 2 1.8 3 3 3s3-1 3-3"/>
    </svg>
);
...
export const GoogleDriveIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M7.71 3.25 1.15 14.26a1.2 1.2 0 0 0 .97 1.74h19.76a1.2 1.2 0 0 0 .97-1.74L16.29 3.25a1.2 1.2 0 0 0-2.06 0l-2.29 4H12l-2.23-4a1.2 1.2 0 0 0-2.06 0zM8.34 18l-3.46 6h6.24l3.47-6H8.34z"/>
    </svg>
);
